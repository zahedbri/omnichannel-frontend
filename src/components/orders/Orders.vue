...
export default {
    ...
    created(){
        ...
        var ordersdata=verification.then(result=>{
            return requester.ajax_request("/api/v1.0/read_orders","POST",this.ac_token,this.rf_token,true,{member_id:this.employer,language_id:this.language_id})
    ...
    methods:{
        seeorder(row){
            ...
            this.$router.push( {path:`/scaffolding/orderitems/${orders_id}`} )
        },
