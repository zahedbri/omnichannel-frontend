                                ...
                                <form @submit.prevent="signuporg">
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-input class="form-control" type="text" v-model="vendorsignup.orgentityname" required placeholder="Company name"></b-form-input>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control" v-model="vendorsignup.logonid" placeholder="Email or Phone" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-input class="form-control" type="password" v-model="vendorsignup.logonpassword" :state="pw_state" aria-describedby="inputLiveHelp inputLiveFeedback" @keyup.native="constrainpassword" required placeholder="Password"></b-form-input>
...
export default {
    ...
    methods: {
        signuporg(){
            ...
            // console.log(payload)
            requester.ajax_request_no_tokens("/api/v1.0/create_vendor_organization","POST",true,payload).done(result => {
        ...
        constrainpassword(e){
            ...
            let uname=this.vendorsignup.logonid
