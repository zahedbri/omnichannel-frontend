                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 col-md-6">
                                ...
                                <p class="text-lead text-light-gray">
                                    Setup your business user account
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-7">
                        <div class="card bg-secondary shadow border-0">
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <form @submit.prevent="signupbusinessuser">
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-user-shield"></i></span>
                                            </div>
                                            <b-form-input class="form-control" type="text" v-model="businessuser.firstname" required placeholder="First name"></b-form-input>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-input class="form-control" type="text" v-model="businessuser.middlename" required placeholder="Middle name"></b-form-input>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-input class="form-control" type="text" v-model="businessuser.lastname" required placeholder="Last name"></b-form-input>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control" v-model="businessuser.logonid" placeholder="Email or Phone" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-input class="form-control" type="password" v-model="businessuser.logonpassword" :state="pw_state" aria-describedby="inputLiveHelp inputLiveFeedback" @keyup.native="constrainpassword" required placeholder="Password"></b-form-input>
...
export default {
    ...
    created(){
        ...
        usersignature.then(result => {
            console.log(result)
            this.businessuser.member_id=result.user.user_id
            this.businessuser.employerid=result.user.employer.employer
            this.businessuser.logonid=result.current_user
        })
    },
    methods: {
        signupbusinessuser(){
            const payload={...this.businessuser}
            requester.ajax_request("/api/v1.0/_create_business_user","POST",this.token,null,true,payload).done(result => {
        ...
        constrainpassword(e){
            ...
            let uname=this.businessuser.logonid
