                ...
                <b-row>
                    <b-col cols="12">
                        <div>
                            <b-card no-body>
                                <b-tabs card>
                                    <b-tab title="Tax Jurisdictions" active>
                                        <b-card no-body>
                                            <b-card-body class="px-0 py-0">
                                                <b-table small show-empty striped hover bordered :current-page="currentPage" :per-page="perPage" :items="taxjursitems" :fields="taxjursfields">
                                                                        ...
                                                                        <b-row>
                                                                            ...
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-2">
                                                                                    ...
                                                                                    <b-form-input size="sm" type="text" v-model="jurst.description" placeholder="Name of tax jurisdiction" required></b-form-input>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="4" md="4">
                                                                            ...
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <b-form-input type="text" size="sm" v-model="jurst.city" placeholder="City of tax jurisdiction"></b-form-input>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="3" md="4">
                                                                                <div class="form-group mb-4">
                                                    ...
                                                    <template v-slot:cell(index)="row">
                                                        <div class="text-center">
                                                            <b-button class="btn-outline-dark btn-sm rounded mr-1" @click="addrow(row)" size="sm" type="button"><i class="fas fa-plus"></i></b-button>
                                                            <b-button class="btn-outline-dark btn-sm rounded" @click="removerow(row.index)" size="sm" type="button"><i class="far fa-trash-alt"></i></b-button>
                                                        </div>
                                                    </template>
                                                </b-table>
                                            </b-card-body>
                                    ...
                                    <b-tab title="Tax Categories">
                                        <b-card no-body>
                                            <b-card-body class="px-0 py-0">
                                                <b-table small show-empty striped hover bordered :current-page="currentPage" :per-page="perPage" :items="taxcatitems" :fields="taxcatfields">
                                                    <template v-slot:head(show_details)>
                                                        <b-form-checkbox disabled></b-form-checkbox>
                                                    </template>
                                                    <template v-slot:cell(show_details)="row">
                                                    ...
                                                    <template v-slot:cell(index)="row">
                                                        <div class="text-center">
                                                            <b-button class="btn-outline-dark btn-sm rounded mr-1" @click="addtaxcat(row)" size="sm" type="button"><i class="fas fa-plus"></i></b-button>
                                                            <b-button class="btn-outline-dark btn-sm rounded" @click="removetaxcat(row.index)" size="sm" type="button"><i class="far fa-trash-alt"></i></b-button>
                                                        </div>
                                                    </template>
                                                    <template v-slot:row-details>
                                                        <b-row class="justify-content-center bg-white">
                                                            <b-col cols="10" class="mr-auto ml-auto">
                                                                <form class="card shadow-sm mb-0 border-1" @submit.prevent="addnewtaxcat">
                                                                    <b-card-body>
                                                                        <b-row>
                                                                            <b-col sm="6" md="6">
                                                                                <div class="form-group mb-4">
                                                                                    <label class="form-label">Tax Type</label>
                                                                                    <b-form-select size="sm" v-model="taxcat.taxtype_id" :options="taxtypeoptions" required></b-form-select>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="6" md="6">
                                                                                <div class="form-group mb-2">
                                                                                    <label class="form-label">Name</label>
                                                                                    <b-form-input size="sm" type="text" v-model="taxcat.name" placeholder="Name" required></b-form-input>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="12" md="12">
                                                                                <div class="form-group mb-2">
                                                                                    <label class="form-label">Name</label>
                                                                                    <b-form-textarea :rows="1" :max-rows="6" v-model="taxcat.description" placeholder="Comment"></b-form-textarea>
                                                                                </div>
                                                                            </b-col>
                                                                        </b-row>
                                                                    </b-card-body>
                                                                    ...
                                                                    <b-card-body>
                                                                        <b-row>
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-4">
                                                                                    <label class="form-label">Tax Type</label>
                                                                                    <b-form-select size="sm" v-model="calcode.calusage_id" @change.native="populatecalmethods" :options="taxtypeoptions" required></b-form-select>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-2">
                                                                        ...
                                                                        <b-row>
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <b-form-select size="sm" v-model="calrule.calcode_id" :options="calcodeoptions" required></b-form-select>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-4">
                                                                            ...
                                                                            <b-col sm="4" md="4">
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <b-form-select size="sm" v-model="calrule.jurstgroup_id" :options="jurstgroupoptions" required></b-form-select>
                                                                                </div>
                                                                            </b-col>
                                                                        </b-row>
                                                                    </b-card-body>
                                                                    ...
                                                                    <b-card-body>
                                                                        <b-row>
                                                                            ...
                                                                            <b-col sm="3" md="3">
                                                                                <div class="form-group mb-4">
                                                                                    <label class="form-label">Tax Type</label>
                                                                                    <b-form-select size="sm" @change.native="populatecalmethods" v-model="calscale.calusage_id" :options="taxtypeoptions" required></b-form-select>
                                                                                </div>
                                                                            </b-col>
                                                                            <b-col sm="3" md="3">
                                                                                <div class="form-group mb-4">
                                                                ...
                                                                <form class="card shadow-sm mb-0 border-1" @submit.prevent="addnewcalrange">
                                                                    <b-card-body>
                                                                        <b-row>
                                                                            <b-col sm="6" md="6">
                                                                                <div class="form-group mb-4">
                                                                                    <label class="form-label">Tax Scale</label>
                                                                            ...
                                                                            <b-col sm="6" md="6">
                                                                                <div class="form-group mb-2">
                                                                                    ...
                                                                                    <b-form-input size="sm" v-model="calrange.value" type="number" step="0.5" placeholder="Value" required></b-form-input>
                                                                                </div>
                                                                            </b-col>
                                                                        </b-row>
                                                                    </b-card-body>
                            ...
                            <b-card-body>
                                <b-row>
                                    ...
                                    <b-col sm="12" md="12">
                                        <div class="form-group mb-2">
                                            <label class="form-label">Name</label>
                                            <b-form-input size="sm" type="text" v-model="jurstgroup.description" placeholder="Name of tax jurisdiction group" required></b-form-input>
                                        </div>
                                    </b-col>
                                </b-row>
                            </b-card-body>
...
export default {
    ...
    data(){
        return {
            ...
            taxtypeoptions:[{value:null,text:"Select Tax Type"}],
            taxcat:{
                taxtype_id:null,
                storeent_id:null,
                name:null,
            ...
            taxcatoptions:[{value:null,text:"Select Tax Category"}],
            calcodeoptions:[{value:null,text:"Select Tax Code"}],
            calscaleitems:null,
            calscalefields:null,
            calscale:{
    ...
    created(){
        ...
        var jurstdata=storesdata.then(result => {
            ...
            this.storeslist.length > 1 ? this.taxcat.storeent_id=this.storeslist[1].value : this.taxcat.storeent_id=null;
            ...
            this.jurstgroup.code=this.employername.substring(0,2).toUpperCase()+'/'+'TX'+'/'+'JG'+'/'+this.selectedstore+'/'+this.jurst.subclass
            return requester.ajax_request("/api/v1.0/read_jurst","POST",this.ac_token,this.rf_token,true,{storeent_id:this.selectedstore,subclass:2})
        })
        var countrydata=jurstdata.then(result => {
            this.taxjursfields=['show_details','code','sub_class','country','state','city','description','index']
        ...
        var jurstgroupdata=countrydata.then(result => {
            ...
            return requester.ajax_request("/api/v1.0/read_jurstgroup","POST",this.ac_token,this.rf_token,true,{storeent_id:this.selectedstore,subclass:2})
        })
        var taxtypedata=jurstgroupdata.then(result=>{
            result.forEach((item)=>{
                this.jurstgroupoptions.push({value:item.jurstgroup_id,text:item.description})
            })
            return requester.ajax_request("/api/v1.0/read_taxtype","GET",this.ac_token,this.rf_token,false,null)
        })
        var taxcgdata=taxtypedata.then(result => {
            result.forEach((item)=>{
                this.taxtypeoptions.push({value:item.taxtype_id,text:item.description})
            })
            return requester.ajax_request("/api/v1.0/read_taxcgry","POST",this.ac_token,this.rf_token,true,{storeent_id:this.selectedstore,language_id:this.language_id})
        })
        var calcodedata=taxcgdata.then(result => {
            result.forEach((item)=>{
                this.taxcatoptions.push({value:item.taxcgry_id,text:item.name})
            })
            this.taxcatfields=['show_details','tax_type','name','description','index']
            this.taxcatitems=result
            return requester.ajax_request("/api/v1.0/read_calcode","POST",this.ac_token,this.rf_token,true,{usages:[3,4],storeent_id:this.selectedstore,language_id:requester.getfromlocalstorage("language_id")})
        })
        var taxcalrules=calcodedata.then(result => {
            // console.log(result)
            result.forEach((item)=>{
                this.calcodeoptions.push({value:item.calcode_id,text:item.description})
            })
            this.calcodefields=['show_details','tax_type','code','description','calculation','application','qualification','index']
            this.calcodeitems=result
            return requester.ajax_request("/api/v1.0/read_taxcalrule","GET",this.ac_token,this.rf_token,false,null)
        })
        ...
        var calscaledata=ffmdata.then(result=>{
            result.forEach((item)=>{
        ...
        var calrangedata=calscaledata.then(result => {
            // console.log(result)
            result.forEach((item)=>{
                this.calscaleoptions.push({value:item.calscale_id,text:item.tax_type})
            })
    ...
    methods:{
        ...
        addnewcalscale(){
            ...
            requester.ajax_request("/api/v1.0/create_taxcalscale","POST",this.ac_token,this.rf_token,true,payload).done(result => {
                ...
                this.calscalefields=['show_details','tax_type','code','description','index']
                result.calscaledata.forEach((item)=>{
                    this.calscaleoptions.push({value:item.calscale_id,text:item.tax_type})
                })
            })
        },
        populatemethods(e){
            let val=e.target.value;
            requester.ajax_request("/api/v1.0/methods_from_taxcat","POST",this.ac_token,this.rf_token,true,{taxcgry_id:val}).done(result => {
                result.forEach((item)=>{
                    this.calmethodoptions.push({value:item.value,text:item.text})
                })
            })
        },
        addnewcalrule(){
            const payload={...this.calrule}
            requester.ajax_request("/api/v1.0/create_taxcalrule","POST",this.ac_token,this.rf_token,true,payload).done(result => {
                console.log(result)
                this.success_message=result.msg
                this.showSnackbar=true
                this.calruleitems=result.calruledata
                this.calrulefields=['show_details','tax_code','tax_category','qualification','calculation','shipping','jurisdiction','index']
                result.calruledata.forEach((item)=>{
                    this.calruleoptions.push({value:item.calrule_id,text:item.tax_code})
                })
            })
        },
        ...
        addnewtaxcat(){
            const payload={...this.taxcat}
            requester.ajax_request("/api/v1.0/create_taxcgry","POST",this.ac_token,this.rf_token,true,payload).done(result => {
                console.log(result)
                this.success_message=result.msg
                this.showSnackbar=true
                this.taxcatfields=['show_details','tax_type','name','description','index']
                this.taxcatitems=result.taxdata
            }).fail((jqXHR,textStatus,errorThrown) => {
                console.log(jqXHR.responseJSON)
                console.log(textStatus)
                console.log(errorThrown)
        ...
        addnewjurst(){
            ...
            requester.ajax_request("/api/v1.0/create_jurst","POST",this.ac_token,this.rf_token,true,payload).done(result => {
                ...
                this.showSnackbar=true
                this.taxjursfields=['show_details','code','sub_class','country','state','city','description','index']
                this.taxjursitems=result.jurstdata
            }).fail((jqXHR,textStatus,errorThrown) => {
                console.log(jqXHR.responseJSON)
                console.log(textStatus)
                console.log(errorThrown)
        ...
        removecalcode(index){
            this.calcodeitems.splice(index,1)
        },
        addcalcode(data){
        ...
        removetaxcat(index){
            this.taxcatitems.splice(index,1)
        },
        addtaxcat(data){
            const copyitems=JSON.parse(JSON.stringify(this.taxcatitems))
            copyitems[data.index]._showDetails=false
            this.taxcatitems.push(copyitems[data.index])
        },
        removerow(index){
            this.taxjursitems.splice(index,1)
        },
        addrow(data){
            const copyitems=JSON.parse(JSON.stringify(this.taxjursitems))
            copyitems[data.index]._showDetails = false //!this.taxjursitems[data.index]._showDetails
            this.taxjursitems.push(copyitems[data.index])
        }
    }
}
</script>
